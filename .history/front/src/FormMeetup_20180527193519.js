    ...
    return (
      <form onSubmit={this.add} onChange={this.handleChange}>
        ...
        <div class="form-check">
          <label class="form-check-label" htmlFor="gratuit">
            <input defaultChecked={this.modalite} class="form-check-input" type="radio" name="modalite" id="gratuit" value="gratuit"  />
            Gratuit
          </label>
           <label class="form-check-label" htmlFor="payant">
            <input defaultChecked={!this.modalite} class="form-check-input" type="radio" name="modalite" id="payant" value="payant"  />
            Payant
          </label>
        </div>
        <div className="form-group">
